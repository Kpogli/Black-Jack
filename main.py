...
def calculate_score(cards_dealt):
    ...
    # calculate_score() check for a blackjack (a hand with only 2 cards: ace + 10)
...
# function to compare(). Pass in the user_score and computer_score.
...
def compare(user_final_score, computer_final_score):
    """Compare user score and computer score to determine winner"""
...
def play_game():
    ...
    while not is_game_over:
        # The score is rechecked with every new card drawn
